      ...
      <div className="flex-row gap-5 lg:flex p-3">
        ...
        <div className="p-5 w-full">
          ...
          <div className="flex gap-2 justify-start items-center">
            <button onClick={HandleWish} className="btn px-7 btn-primary mt-4">WishList</button>
            <button onClick={BackHandle} className="btn px-7 btn-success btn-outline mt-4">Go Back</button>
          </div>
        </div>
      </div>
    </div>
